...
test('legacy newsroom content builds a complete controlled English baseline', () => {
	...
	assert.deepEqual(catalogue.articles.flatMap((article) => article.omittedInlineImages), ['latam-content.jpg', 'space-content.jpg'])
...
test('an empty hosted project produces create-only operations', () => {
	...
	assert.deepEqual(plan.counts, { created: 26, skipped: 0, conflicting: 0 })
